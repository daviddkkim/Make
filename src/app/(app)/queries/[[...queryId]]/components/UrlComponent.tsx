...
export default function UrlComponent(props: DivProps) {
    ...
    const variableUrl = isEmptyObject(props.variables) ? props.url : replaceUrlVariables(props.url, props.variables);
    return (
        <Tooltip open={props.tooltipOpen ?? false}>
            ...
            <TooltipContent className="w-full w-[calc(var(--radix-tooltip-trigger-width)+34px)]" side="bottom" align="start" sideOffset={0}>
